    ...
    <Sidebar>
      <section className="edit-wrap">
        <nav className="Edit-navbar">
          <h3 className="Edit-Profile-text">Edit Profile</h3>
        ...
        <div className="edit-profile-page">
          ...
          <label htmlFor="profilePhotoInput" onClick={updateProfilePhoto}>
            ...
            >
              <img className="edit-avatar" src={profilePhoto} alt="profile" />
            </div>
          </label>
          ...
          <form className="edit-form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="edit-city">
              <div className="edit-input-left">
                <label className="edit-label" htmlFor="secondary">
              ...
              <div className="edit-input-right">
                ...
                <input
                  ...
                  type="city"
                  name="Country"
                  placeholder="College Of Edu/University/Poly"
                  {...register("Country", {
                    required: true,
                  })}
                />
            ...
            <br /> <br /> <br />
            <div className="edit-names">
              <div className="edit-input-left faculty">
                <label className="edit-label" htmlFor="state">
                  Faculty/Department
                </label>
                <br />
                <span className="edit-span">
                  e.g Science/Biochemistry, Engeering/Civil Engr.
                </span>
                <br />
                <input
                  className="edit-input"
              ...
              <br />
              <br /> <br />
              <div className="edit-input-right year">
                <label className="edit-label" htmlFor="Country">
                  Year of Study
                </label>
                <br />
